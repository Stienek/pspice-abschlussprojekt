...
ax42 = ax41.twinx()
ax41.plot([(i + 4)*12.5 for i in a22vtrig], [1000*i for i in a22pr5], linewidth=lwidth, linestyle='-', color='blue', label=r"$P_{R1}$")
ax41.plot([(i + 4)*12.5 for i in a22vtrig], [1000*i for i in a22pr4], linewidth=lwidth, linestyle='--', color='blue', label=r"$P_{R2}$")
ax41.plot([(i + 4)*12.5 for i in a22vtrig], [1000*i for i in a22pr3], linewidth=lwidth, linestyle=':', color='blue', label=r"$P_{R4}$")
ax41.plot([(i + 4)*12.5 for i in a22vtrig], [1000*i for i in a22pr2], linewidth=lwidth, linestyle='-.', color='blue', label=r"$P_{R3}$")
ax42.plot([(i + 4)*12.5 for i in a22vtrig], a22pq1, linewidth=lwidth, linestyle='-', color='orange', label=r"$P_{Q1_{ds}}$")
ax41.set_xlim(0, 100)
...
coef = np.polyfit([(i + 4)*12.5 for i in a23vtrig], [1000*i for i in a23pq1], 1)
poly1d_fn = np.poly1d(coef) 
ax51 = fig5.add_subplot(gs5[0, 0])
ax52 = ax51.twinx()
ax51.plot([(i + 4)*12.5 for i in a23vtrig], [1000*i for i in a23pr5], linewidth=lwidth, linestyle='-', color='blue', label=r"$P_{R1}$")
ax51.plot([(i + 4)*12.5 for i in a23vtrig], [1000*i for i in a23pr4], linewidth=lwidth, linestyle='--', color='blue', label=r"$P_{R2}$")
ax51.plot([(i + 4)*12.5 for i in a23vtrig], [1000*i for i in a23pr3], linewidth=lwidth, linestyle=':', color='blue', label=r"$P_{R4}$")
ax51.plot([(i + 4)*12.5 for i in a23vtrig], [1000*i for i in a23pr2], linewidth=lwidth, linestyle='-.', color='blue', label=r"$P_{R3}$")
ax52.plot([(i + 4)*12.5 for i in a23vtrig], poly1d_fn([(i + 4)*12.5 for i in a23vtrig]) , linewidth=lwidth, linestyle='-', color='orange', label=r"$P_{Q2_{ds}}$")
ax51.set_xlim(0, 100)
ax51.set_ylim(0, 7)
ax52.set_ylim(0, 14)
ax51.set_xlabel(r"Einschaltdauer $[ \% ]$")
ax51.set_ylabel(r"Verlustleistung $[ mW ]$", color='blue')
ax52.set_ylabel(r"Verlustleistung $[ mW ]$", color='orange')
ax51.grid()
ax51.legend()
ax52.legend()
...
fig4.tight_layout()
fig5.tight_layout()
fig1.savefig("../medien/1.eps")
fig2.savefig("../medien/2.eps")
fig3.savefig("../medien/3.eps")
fig4.savefig("../medien/4.eps")
fig5.savefig("../medien/5.eps")
plt.show()
